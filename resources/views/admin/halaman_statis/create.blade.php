@extends('layouts.app')
@section('title', request()->get('slug') == 'visi-misi' ? 'Buat Visi & Misi' : 'Tambah Halaman')
                    ...
                    <div class="d-flex align-items-center justify-content-between text-white">
                        <div class="d-flex align-items-center">
                            <div class="page-header-icon">
                                <i class="fas {{ request()->get('slug') == 'visi-misi' ? 'fa-bullseye' : 'fa-plus-circle' }}"></i>
                            </div>
                            <div>
                                <h3 class="page-header-title">{{ request()->get('slug') == 'visi-misi' ? 'Buat Visi & Misi' : 'Tambah Halaman Statis' }}</h3>
                                <p class="page-header-subtitle">{{ request()->get('slug') == 'visi-misi' ? 'Buat halaman visi dan misi organisasi' : 'Buat halaman profil atau informasi baru untuk website' }}</p>
                            </div>
                        </div>
                        <div class="text-right d-none d-md-block">
                            <a href="{{ route('admin.halaman-statis.index') }}{{ request()->get('slug') == 'visi-misi' ? '?filter=visi-misi' : '' }}" class="btn btn-light btn-modern">
                    ...
                    <div class="content-card-body form-modern">
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror"
                                   value="{{ old('slug', request()->get('slug')) }}" placeholder="contoh: visi-misi" required {{ request()->get('slug') == 'visi-misi' ? 'readonly' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror"
                                   value="{{ old('judul', request()->get('slug') == 'visi-misi' ? 'Visi & Misi' : '') }}" placeholder="contoh: Visi & Misi" required>
                            @error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="form-group">
                            <label>Icon <small class="text-muted">(Font Awesome)</small></label>
                            <input type="text" name="icon" class="form-control" value="{{ old('icon', request()->get('slug') == 'visi-misi' ? 'fas fa-bullseye' : 'fas fa-file-alt') }}"
            ...
            <div class="col-lg-4">
                ...
                <div class="content-card mt-3">
                    <div class="content-card-body">
                        ...
                        <a href="{{ route('admin.halaman-statis.index') }}" class="btn btn-secondary btn-block mt-2">
