            ...
            <div class="filter-box">
                <form method="GET">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-2">
                            <div class="form-group mb-0">
                                ...
                                <select name="status_pengajuan" class="form-control">
                                    ...
                                    <option value="pending" {{ request('status_pengajuan') === 'pending' ? 'selected' : '' }}>â³ Pending</option>
                                    <option value="diproses" {{ request('status_pengajuan') === 'diproses' ? 'selected' : '' }}>âš™ï¸ Diproses</option>
                                    <option value="disetujui" {{ request('status_pengajuan') === 'disetujui' ? 'selected' : '' }}>âœ… Disetujui</option>
                                    <option value="ditolak" {{ request('status_pengajuan') === 'ditolak' ? 'selected' : '' }}>âŒ Ditolak</option>
                                    <option value="selesai" {{ request('status_pengajuan') === 'selesai' ? 'selected' : '' }}>ðŸ Selesai</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-1">
                            <div class="form-group mb-0">
                                <a href="{{ route('pimpinan.laporan.bantuan') }}" class="btn btn-secondary btn-block" style="border-radius:10px;font-weight:700" title="Reset">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                <div class="d-flex gap-2" style="gap:10px">
                                    ...
                                    <a href="{{ route('pimpinan.laporan.exportExcel', ['type'=>'bantuan'] + request()->all()) }}" class="btn btn-export-excel flex-fill" title="Excel">
                                        <i class="fas fa-file-excel"></i> Excel
                                    </a>
                                    <a href="{{ route('pimpinan.laporan.exportWord', ['type'=>'bantuan'] + request()->all()) }}" class="btn btn-export-word flex-fill" title="Word">
                                        <i class="fas fa-file-word"></i> Word
                                    </a>
                                    <a href="{{ route('pimpinan.laporan.exportPdf', ['type'=>'bantuan'] + request()->all()) }}" class="btn btn-export-pdf flex-fill" title="PDF">
        ...
        <div class="content-card-body border-top">
            <div class="d-flex justify-content-between align-items-center">
                <small class="text-muted font-weight-600">
                    Menampilkan {{ $pengajuanBantuan->firstItem() }}â€“{{ $pengajuanBantuan->lastItem() }} dari {{ $pengajuanBantuan->total() }} pengajuan
                </small>
                <div>
