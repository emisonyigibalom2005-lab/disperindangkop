            ...
            <div class="col-lg-10">
                        ...
                        <div style="flex:1;">
                            ...
                            <div style="color:#1e3a8a;line-height:1.6;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <small><i class="fas fa-calendar-times mr-1"></i> <strong>Berakhir:</strong> {{ \Carbon\Carbon::parse($periodeAktif->tanggal_selesai)->format('d M Y') }}</small>
                                    </div>
                                </div>
                                <div class="mt-2">
                                    <small>
                ...
                <div class="card" style="border-radius:16px;border:none;box-shadow:0 4px 20px rgba(0,0,0,0.08)">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('petugas.anggota.store') }}" method="POST" enctype="multipart/form-data" id="formPendaftaran" novalidate>
                            @csrf
