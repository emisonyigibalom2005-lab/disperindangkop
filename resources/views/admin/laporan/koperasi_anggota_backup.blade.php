...
@media print {
    ...
    .table-modern tbody td:nth-child(7) { text-align: center !important; } /* Tgl Lahir */
    .table-modern tbody td:nth-child(8) { text-align: center !important; } /* JK */
    .table-modern tbody td:nth-child(17) { text-align: center !important; } /* Kode Pos */
    .table-modern tbody td:nth-child(21) { text-align: center !important; } /* Lama Usaha */
    .table-modern tbody td:nth-child(22) { text-align: center !important; } /* Jumlah Karyawan */
    .table-modern tbody td:nth-child(23) { text-align: right !important; } /* Modal Usaha */
    .table-modern tbody td:nth-child(24) { text-align: right !important; } /* Omzet */
    .table-modern tbody td:nth-child(35) { text-align: right !important; } /* Simpanan Pokok */
    .table-modern tbody td:nth-child(36) { text-align: right !important; } /* Simpanan Wajib */
    ...
    /* Remove background colors for badges in print */
    .badge-no-anggota {
        background: transparent !important;
        color: #000 !important;
        ...
        <div class="col-12">
            <div class="card card-modern" style="background:linear-gradient(135deg,#667eea,#764ba2)">
                <div class="card-body p-4">
                    ...
                    <form method="GET" action="{{ route('admin.laporan.koperasi') }}">
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <div class="d-flex" style="gap:8px">
                                    ...
                                    <a href="{{ route('admin.laporan.koperasi') }}" class="btn btn-secondary" style="border-radius:10px;font-weight:700" title="Reset">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-md-end flex-wrap" style="gap:8px">
                                ...
                                <a href="{{ route('admin.laporan.exportExcel', ['type' => 'anggota'] + request()->all()) }}" 
                                   class="btn btn-light btn-sm download-btn" 
                                   style="border-radius:10px;font-weight:600">
                                    <i class="fas fa-file-excel mr-1" style="color:#10b981"></i>Excel
                                </a>
                                <a href="{{ route('admin.laporan.exportWord', ['type' => 'anggota'] + request()->all()) }}" 
                                   class="btn btn-light btn-sm download-btn" 
                                   style="border-radius:10px;font-weight:600">
                                    <i class="fas fa-file-word mr-1" style="color:#2563eb"></i>Word
                                </a>
                                <a href="{{ route('admin.laporan.exportPdf', ['type' => 'anggota'] + request()->all()) }}" 
                                   class="btn btn-light btn-sm download-btn" 
                                   style="border-radius:10px;font-weight:600">
                    ...
                    <div class="table-responsive">
                        <table class="table table-modern table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="39" class="text-center py-5">
                ...
                <div class="card-footer no-print" style="background:linear-gradient(135deg,#fef3c7,#fde68a);border-radius:0 0 16px 16px;padding:15px;border-top:3px solid #f59e0b">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span style="color:#78350f"> | Export untuk melihat semua kolom data lengkap (38 kolom)</span>
                        </div>
                    </div>
                </div>
            </div>
