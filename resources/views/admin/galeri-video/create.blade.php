...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h3 class="page-header-title">🎥 Tambah Video Galeri</h3>
                                <p class="page-header-subtitle">Embed video dari YouTube untuk dokumentasi kegiatan</p>
                            </div>
                        </div>
    ...
    <form action="{{ route('admin.galeri-video.store') }}" method="POST" id="formVideo">
        @csrf
            ...
            <div class="col-lg-9">
                <div class="content-card">
                    ...
                    <div class="content-card-body">
                        <div class="video-input-card text-center mb-4">
                            <div class="video-icon-header">
                                <i class="fab fa-youtube"></i>
                            </div>
                            <h4 class="font-weight-bold mb-2" style="color:#1a3a6e">Embed Video YouTube</h4>
                            <p class="text-muted mb-0">Masukkan URL video YouTube untuk ditampilkan di galeri</p>
                        </div>
                        ...
                        <div id="videoPreviewContainer" class="d-none">
                            ...
                            <div class="text-center mt-3">
                                <span class="badge badge-success-modern" style="font-size:13px;padding:8px 16px">
                                    <i class="fas fa-check-circle mr-1"></i>Video berhasil dimuat
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control form-control-modern" rows="3" placeholder="Tambahkan deskripsi singkat...">{{ old('deskripsi') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
// Auto preview if URL exists (for old input)
