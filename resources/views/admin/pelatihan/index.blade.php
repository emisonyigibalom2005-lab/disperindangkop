...
<div class="card card-primary card-outline">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.pelatihan.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus mr-1"></i>Tambah Pelatihan</a>
    </div>
    <div class="card-body p-0">
        <table class="table table-hover mb-0">
            <thead class="thead-light">
                <tr><th>Judul</th><th>Tanggal</th><th>Lokasi</th><th>Kuota</th><th>Peserta</th><th>Status</th><th>Aksi</th></tr>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.pelatihan.peserta', $p) }}" class="btn btn-xs btn-info" title="Peserta"><i class="fas fa-users"></i></a>
                    <a href="{{ route('admin.pelatihan.edit', $p) }}" class="btn btn-xs btn-warning"><i class="fas fa-edit"></i></a>
                    <form method="POST" action="{{ route('admin.pelatihan.destroy', $p) }}" style="display:inline" onsubmit="return confirm('Hapus?')">
                        @csrf @method('DELETE')
