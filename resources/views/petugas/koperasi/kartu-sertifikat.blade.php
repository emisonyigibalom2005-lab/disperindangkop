...
<head>
    ...
    <style>
        ...
        /* Border Emas Luar - Multiple Layers */
        .sertifikat-border-outer {
            ...
            border-radius: 0;
            padding: 0;
            box-shadow: inset 0 0 0 2px #8b7355, inset 0 0 0 4px #d4af37, inset 0 0 0 6px #8b7355;
        }

        /* Border Inner dengan Multiple Lines */
        .sertifikat-border-inner {
            ...
            padding: 0;
            position: relative;
            box-shadow: inset 0 0 0 2px #d4af37, inset 0 0 0 4px #8b7355;
        }

        /* Header Merah Melengkung */
        .sertifikat-header-curve {
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
        ...
        /* Kop Surat di Header Merah */
        .sertifikat-kop {
            position: relative;
            text-align: center;
            padding: 8mm 20mm 0 20mm;
            z-index: 3;
            color: white;
        }
        }
                ...
                <div class="sertifikat-border-inner">
                    ...
                    <div class="sertifikat-content">
                        ...
                        <div class="sertifikat-detail">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>{{ $koperasi->tempat_lahir ?? 'Tolikara' }}, {{ $koperasi->tanggal_lahir ? \Carbon\Carbon::parse($koperasi->tanggal_lahir)->format('d F Y') : '-' }}</td>
                                </tr>
                                <tr>
                                    <td>Alamat</td>
                                    <td>:</td>
                                    <td>{{ $koperasi->distrik }}, Kab. Tolikara</td>
                                </tr>
                                <tr>
                                    <td>Koperasi</td>
                                    <td>:</td>
                                    <td>{{ $koperasi->nama_koperasi ?? 'Koperasi Tolikara' }}</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="sertifikat-text">
                            ...
                            sejak tanggal <strong>{{ $koperasi->created_at ? $koperasi->created_at->format('d F Y') : \Carbon\Carbon::now()->format('d F Y') }}</strong><br>
