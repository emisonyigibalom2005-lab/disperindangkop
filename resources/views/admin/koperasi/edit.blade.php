...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.koperasi.show', $koperasi) }}">{{ $koperasi->nama_usaha }}</a></li>
...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        {{-- Foto Usaha --}}
        <div class="card shadow-sm">
            <div class="card-header"><h3 class="card-title"><i class="fas fa-image mr-2"></i>Foto Usaha</h3></div>
            <div class="card-body">
                @if($koperasi->foto_usaha)
                    <img src="{{ asset("storage/".$koperasi->foto_usaha) }}" class="img-fluid rounded mb-2" style="max-height:200px;width:100%;object-fit:cover">
                @endif
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <a href="{{ route('admin.koperasi.show', $koperasi) }}" class="btn btn-secondary btn-block py-2">
