...
@section('content')
<form action="{{ route('admin.koperasi.store') }}" method="POST" enctype="multipart/form-data">
@csrf
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label fw-bold">Foto Usaha</label>
                        <input type="file" name="foto_usaha" accept="image/*" class="form-control"
                            onchange="if(this.files[0]){var r=new FileReader();r.onload=function(e){var p=document.getElementById('prevFoto');p.src=e.target.result;p.classList.remove('d-none');};r.readAsDataURL(this.files[0]);}">
                        <img id="prevFoto" src="" class="mt-2 d-none rounded" style="max-height:160px;object-fit:cover;">
                ...
                <a href="{{ route('admin.koperasi.index') }}" class="btn btn-secondary btn-block py-2">
