...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between text-white">
                        ...
                        <div class="text-right d-none d-md-block">
                            <a href="{{ route('admin.galeri.index') }}?tipe=foto" class="btn btn-light btn-modern">
    ...
    <form action="{{ route('admin.galeri.update', $galeri) }}" method="POST" enctype="multipart/form-data" id="formFoto">
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-9">
                ...
                <div class="content-card mb-4">
                    ...
                    <div class="content-card-body text-center">
                        <div class="preview-container">
                            <img src="{{ asset('storage/' . $galeri->foto) }}" alt="{{ $galeri->judul }}" class="preview-image">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control" rows="3" placeholder="Tambahkan deskripsi singkat..." style="border-radius:10px;border:2px solid #e0e7ff">{{ old('deskripsi', $galeri->deskripsi) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-card mt-4">
                    <div class="content-card-body" style="background:#f8f9ff;border-top:1px solid #eef;display:flex;justify-content:space-between;align-items:center;padding:25px 30px">
                        <a href="{{ route('admin.galeri.index') }}?tipe=foto" class="btn btn-secondary btn-modern">
